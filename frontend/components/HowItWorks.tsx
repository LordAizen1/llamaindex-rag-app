  ...
  return (
    <div className="rounded-xl border border-ink-700 bg-ink-900/40 p-4 text-sm text-slate-400 leading-relaxed">
      ...
      <p>
        ...
        <span className="text-slate-300">ChromaDB</span>. When you ask something, it finds the
        best-matching chunks — by both keyword and meaning — and sends them to{" "}
        <span className="text-slate-300">gpt-4.1-mini</span>, which only answers from those chunks.
        If the answer isn&apos;t in your files it says so instead of guessing, and you can always
        check the exact text it used.
      </p>
